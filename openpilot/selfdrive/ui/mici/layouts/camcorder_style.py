...
BODY_COLOR = rl.Color(29, 30, 29, 255)
VIEWFINDER_PANEL_COLOR = rl.Color(35, 32, 27, 255)
VIEWFINDER_EDGE_LIGHT = rl.Color(61, 56, 48, 255)
VIEWFINDER_EDGE_DARK = rl.Color(9, 8, 7, 255)
